...
# NOTE: You might want to remove this if mariadb is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if mariadb has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert mariadb executable exists.
		local tool_cmd
